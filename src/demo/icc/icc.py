...
ic_weight_hd5_path = './output/prepared/ICCombine/ic_weight.hd5'
# custom_data_path = './output/ICCombine', 'custom_date.json'
custom_data_path = 'custom_date.json'
...
def store_ic_weight():
    ...
    # print(factorList_adj)
    # print(custom_data_path)
    # 这句话出错了
    # 看看是什么原因, 原因是没有这个文件，手动创建，并且不是tuple
